...
export const ImageWidget = ({content, id, edit, editable})=>{
    ...
    return (
        ...
        <div className="overflow-hidden h-[99%] min-w-[360px] bg-red-400 max-w-[720px] md:bg-amber-300"
//         style={{ backgroundImage: `url('${url}')`,  backgroundRepeat: 'no-repeat',
//   backgroundPosition: 'center center',
//   backgroundSize: 'cover'}}
        >
            <img src={url} className="min-w-[358px] bg-red-400 max-w-[718px] md:bg-amber-300 h-auto object-contain overflow-hidden hidden"/>
