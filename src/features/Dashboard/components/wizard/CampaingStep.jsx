...
export const CampaignStep = ({data, setData})=>{
    ...
    useEffect(()=>{
        ...
        getByCompanyId("CompaniesDomain", stored?.company.id).then(res=> setDomains(res.data))
   ...
   return (
     <div className="justify-self-center w-full ">
        ...
        <Select  className="my-5 w-sm sm:w-md" onChange={(e)=> setData(prev=> ({...prev, "idCampaign": parseInt(e.target.value)})) }>
