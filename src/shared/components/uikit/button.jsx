...
const styles = {
  ...
  solid: [
    ...
    'before:absolute before:inset-0 before:-z-1 before:rounded-[calc(var(--radius-lg)-1px)] before:bg-(--btn-bg)',
    ...
    'after:absolute after:inset-0 after:-z-1 after:rounded-[calc(var(--radius-lg)-1px)]',
